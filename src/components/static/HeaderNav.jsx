  ...
  return (
    <div className='bg-blue-950 flex justify-between items-center h-24 max-w-[1440px] mx-auto px-4 text-white'>
      ...
      <div onClick={handleNav} className='block md:hidden'>
        {nav ? <AiOutlineMenu size={20} className='hover: cursor-pointer' /> : <AiOutlineMenu size={20} className='hover: cursor-pointer' />}
      </div>
      ...
      >
        ...
        <li>
          <div onClick={handleNav} className='flex md:hidden pl-1 pt-3'>
            {nav ? <AiOutlineClose size={30} className='hover: cursor-pointer' /> : <AiOutlineClose size={30} className='hover: cursor-pointer' />}
            </div>
        </li>
      </ul>
    </div>
